...
public class Configuracion implements ActionListener, ItemListener{
    ...
    private String[] opcionTemas ={"Arte", "Ciencia", "Deportes","Musica",
        "Personajes", "Tecnologia", "Programacion", "Otros"};
    ...
    public void Decora(){
        ...
        panel.setBorder((Border) new PanelBorder(Color.WHITE, Color.BLACK, 5, TitledBorder.CENTER, ""));        
    ...
    public void Escuchadores(){
        ...
        muyDificil.addActionListener(this);
