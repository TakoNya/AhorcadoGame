...
public class FrameAhorcado extends JFrame implements ActionListener {
    ...
    public FrameAhorcado() {
        ...
        principal.add(opcionInicial, BorderLayout.CENTER);
    ...
    public JPanel Interactua() {
        ...
        palabras.setFont(new Font("", Font.PLAIN, 30));
    ...
    public JPanel Teclado() {
        ...
        String[] letras = {"A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "Ñ", "O", "P", "Q",
            "R", "S", "T", "W", "X", "Y", "Z", "Nuevo", "Solucion", "Salir"};
        ...
        for (int i = 0; i < botones.length; i++) {
            ...
            if (i > 26) {
                botones[i] = new JButton(letras[i], new ImageIcon(getClass().getResource("/recutsos/Boton2.jpeg")));
                botones[i].setForeground(Color.WHITE);
            } else {
    ...
    public void ActualizaDibujo() {
        switch (oportunidades) {
            ...
            default: {
                Dibujo(new ImageIcon(getClass().getResource("/recursos/Aho1.gif")));
            }
        }
    }
